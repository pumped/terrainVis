...
AnimatedRaster.prototype.getSource = function() {
	that = this;

	if (!this.hasOwnProperty("olSource")) {
		this.olSource = new ol.source.ImageCanvas({
			canvasFunction: function canvasEscape(extent, resolution, pixelRatio, size, projection){return that.getCanvas(extent, resolution, pixelRatio, size, projection);},
			ratio: this.ratio,
			projection: 'EPSG:3857'
			//imageExtent: [16329395.22661877,-2186710.505182322,16334287.196429022,-2181818.535372071]
		});
	}
...
AnimatedRaster.prototype.reconfigure = function(params) {
	...
	if (params.hasOwnProperty("ratio")) {
